					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proyecto Luthier",
									"targetURL": "#aca20241q-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"aca20241q-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aca20241q",
									"url": sap.ui.require.toUrl("aca20241q")
								}
							}
						}
					}
